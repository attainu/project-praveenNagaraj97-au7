...
productReviewRouter.route("/addElectronicsReview").post(upload.array("productReviewImage"), // (req, res, next) => {
//   res.send(req.files);
// },
_productReviewController.protectRoute, _productReviewController.preFillUserId, _productReviewController.handleProductReviewImage, _productReviewController.processProductReviewImage, _productReviewController.addProductElectronicsReview);