...
productRouter.route("/dev/addNewProduct").post(upload.array("productCoverImage"), _productsController.protectRoute, _productsController.getProductImageProcessed, _productsController.productImageLink, _productsController.addNewProduct);
productRouter.route("/dev/addManufacturer").post(_productsController.addProductManufacturer);
